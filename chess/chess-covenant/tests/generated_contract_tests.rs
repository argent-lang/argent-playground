...
fn size_snapshots() -> [SizeSnapshot; 12] {
    ...
    [
        ...
        SizeSnapshot {
            actor: "Mux",
            expected_script_len: 2176,
            expected_instruction_count: 1361,
            expected_charged_op_count: 927,
        ...
        SizeSnapshot {
            actor: "Pawn",
            expected_script_len: 1990,
            expected_instruction_count: 1289,
            expected_charged_op_count: 850,
        ...
        SizeSnapshot {
            actor: "Knight",
            expected_script_len: 1581,
            expected_instruction_count: 912,
            expected_charged_op_count: 599,
        ...
        SizeSnapshot {
            actor: "Vert",
            expected_script_len: 2114,
            expected_instruction_count: 1411,
            expected_charged_op_count: 959,
        ...
        SizeSnapshot {
            actor: "Horiz",
            expected_script_len: 2113,
            expected_instruction_count: 1410,
            expected_charged_op_count: 959,
            baseline_script_len: 2104,
            baseline_instruction_count: 1469,
            baseline_charged_op_count: 1011,
        ...
        SizeSnapshot {
            actor: "Diag",
            expected_script_len: 2121,
            expected_instruction_count: 1431,
            expected_charged_op_count: 978,
        ...
        SizeSnapshot {
            actor: "King",
            expected_script_len: 1653,
            expected_instruction_count: 968,
            expected_charged_op_count: 640,
        ...
        SizeSnapshot {
            actor: "Castle",
            expected_script_len: 1646,
            expected_instruction_count: 1000,
            expected_charged_op_count: 652,
