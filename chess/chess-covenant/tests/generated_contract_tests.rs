...
fn size_snapshots() -> [SizeSnapshot; 12] {
    ...
    [
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 924,
            expected_charged_op_count: 607,
        ...
        SizeSnapshot {
            actor: "Vert",
            expected_script_len: 2130,
            expected_instruction_count: 1425,
            expected_charged_op_count: 968,
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 1424,
            expected_charged_op_count: 968,
            baseline_script_len: 2104,
            baseline_instruction_count: 1469,
            baseline_charged_op_count: 1011,
        ...
        SizeSnapshot {
            actor: "Diag",
            expected_script_len: 2137,
            expected_instruction_count: 1445,
            expected_charged_op_count: 987,
        ...
        SizeSnapshot {
            actor: "King",
            expected_script_len: 1667,
            expected_instruction_count: 980,
            expected_charged_op_count: 648,
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 1176,
