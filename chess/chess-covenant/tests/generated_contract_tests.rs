...
fn size_snapshots() -> [SizeSnapshot; 12] {
    ...
    [
        ...
        SizeSnapshot {
            actor: "Pawn",
            expected_script_len: 2004,
            expected_instruction_count: 1303,
            expected_charged_op_count: 859,
        ...
        SizeSnapshot {
            actor: "Knight",
            expected_script_len: 1603,
            expected_instruction_count: 926,
        ...
        SizeSnapshot {
            actor: "Vert",
            expected_script_len: 2139,
            expected_instruction_count: 1434,
            expected_charged_op_count: 977,
        ...
        SizeSnapshot {
            actor: "Horiz",
            expected_script_len: 2138,
            expected_instruction_count: 1433,
            expected_charged_op_count: 977,
            baseline_script_len: 2104,
            baseline_instruction_count: 1469,
            baseline_charged_op_count: 1011,
        ...
        SizeSnapshot {
            actor: "Diag",
            expected_script_len: 2146,
            expected_instruction_count: 1454,
            expected_charged_op_count: 996,
        ...
        SizeSnapshot {
            actor: "King",
            expected_script_len: 1669,
            expected_instruction_count: 982,
            expected_charged_op_count: 650,
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 1020,
            expected_charged_op_count: 667,
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 1177,
